...
Q_CONSTINIT static const qt_meta_stringdata_CurrentDay_t qt_meta_stringdata_CurrentDay = {
    {
        ...
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 14),  // "clickAddButton"
        QT_MOC_LITERAL(39, 10),  // "dataUpSlot"
        QT_MOC_LITERAL(50, 13),  // "clickCellItem"
        QT_MOC_LITERAL(64, 3)   // "row"
    },
    "CurrentDay",
    "dataChanged",
    "",
...
void CurrentDay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->clickAddButton(); break;
        case 2: _t->dataUpSlot(); break;
        case 3: _t->clickCellItem((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &CurrentDay::dataChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
