...
Q_CONSTINIT static const qt_meta_stringdata_Notes_t qt_meta_stringdata_Notes = {
    {
        ...
        QT_MOC_LITERAL(6, 6),  // "dataUp"
        QT_MOC_LITERAL(13, 0),  // ""
        QT_MOC_LITERAL(14, 15),  // "clickSaveButton"
        QT_MOC_LITERAL(30, 14),  // "clickDelButton"
        QT_MOC_LITERAL(45, 10)   // "changeData"
    },
    "Notes",
    "dataUp",
    "",
...
void Notes::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->dataUp(); break;
        case 1: _t->clickSaveButton(); break;
        case 2: _t->clickDelButton(); break;
        ...
        {
            using _t = void (Notes::*)();
            if (_t _q_method = &Notes::dataUp; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
